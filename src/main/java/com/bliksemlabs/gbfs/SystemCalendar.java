...
public class SystemCalendar {
    ...
    private int ttl;
    @JsonProperty("data")
    private SystemCalendarData data;
    @JsonIgnore
     ...
     * @param ttl
     */
    public SystemCalendar(long lastUpdated, int ttl, SystemCalendarData data) {
        super();
    ...
    public SystemCalendar withLastUpdated(long lastUpdated) {
        this.lastUpdated = lastUpdated;
        return this;
    }
    ...
    public SystemCalendar withTtl(int ttl) {
        this.ttl = ttl;
        return this;
    }

    @JsonProperty("data")
    public SystemCalendarData getData() {
        return data;
    }

    @JsonProperty("data")
    public void setData(SystemCalendarData data) {
        this.data = data;
    }

    public SystemCalendar withData(SystemCalendarData data) {
        this.data = data;
        return this;
    }
    ...
    public SystemCalendar withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
