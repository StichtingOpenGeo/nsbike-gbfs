...
public class SystemHours {
     ...
     * @param ttl
     */
    public SystemHours(long lastUpdated, int ttl, SystemHoursData data) {
        super();
    ...
    public SystemHours withLastUpdated(long lastUpdated) {
        this.lastUpdated = lastUpdated;
        return this;
    }
    ...
    public SystemHours withTtl(int ttl) {
        this.ttl = ttl;
        return this;
    }

    @JsonProperty("data")
    public SystemHoursData getData() {
        return data;
    }

    @JsonProperty("data")
    public void setData(SystemHoursData data) {
        this.data = data;
    }

    public SystemHours withData(SystemHoursData data) {
        this.data = data;
        return this;
    }
    ...
    public SystemHours withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
